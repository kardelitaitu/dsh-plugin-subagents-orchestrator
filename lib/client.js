...
function SubagentsOrchestratorSection({ inject: inject2 }) {
  ensureCss();
  const scope = inject2?.scope;
  const useScope = inject2?.useScope;
  ...
  const [draft, setDraft] = (0, import_react.useState)({ ...DEFAULTS, ...stored });
